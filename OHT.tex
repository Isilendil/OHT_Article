...
\citeauthor{wei2011heterogeneous}\shortcite{wei2011heterogeneous} applied restricted Boltzmann machine to perform heterogeneous transfer learning task.
...
\citeauthor{yang2009heterogeneous}\shortcite{yang2009heterogeneous} leveraged text data for image clustering, and \citeauthor{zhu2011heterogeneous}\shortcite{zhu2011heterogeneous} utilized text data for image classification task.
\citeauthor{wang2009building}\shortcite{wang2009building} proposed a algorithm to build two separate classifiers based on text features and image features, and then the final classifier is trained to combine them.
...
The regularization parameter $C = 5$, and $ \beta = \frac{\sqrt{T}}{\sqrt{T}+\sqrt{2\ln{4}}} $ for OHT2 algorithm.
